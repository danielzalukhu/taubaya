...
class SubjectController extends Controller
{
    ...
    public function subjectDetail(Request $request, $id)
    {
        ...
        if(Auth::guard('web')->user()->ROLE === "STAFF"){
            ...
            $selected_student_ay = Student::select('ACADEMIC_YEAR_ID AS AY_ID')->where('GRADES_ID', $select_student_ay_in)->limit(1)->first()->AY_ID;
    ...
    public function teacherGetStudentSubject($idsiswa, $kodelkelas)
    {
        ...
        return view('subject.teacher-get-student-subject', compact('siswa', 'subject'));
    }    
    ...
    public function getStudentSubjectDetail(Request $request, $idsiswa, $idmapel)
    {
        ...
        return view('subject.teacher-get-student-detail-subject',
